...
Output requirements:
- Generate one markdown file per controller method in `docs/charts/organizations`.
...
- `docs/charts/organizations/organizations-search-controller-flow.md`
- `docs/charts/organizations/organizations-search-post-controller-flow.md`
- `docs/charts/organizations/organizations-create-controller-flow.md`
- `docs/charts/organizations/organizations-read-controller-flow.md`
- `docs/charts/organizations/organizations-get-parents-controller-flow.md`
- `docs/charts/organizations/organizations-update-controller-flow.md`
- `docs/charts/organizations/organizations-delete-controller-flow.md`
...
- `create`: show parent organization lookup only when `parentOrgId` is provided; include duplicate name validation, image signature validation, custom field validation, repository create, and event publication. Keep create-path method labels concise: prefer `create(params)` over expanded field lists and `validate("Organization", metadata, parentOrgId)` over `validate("Organization", params.metadata, params.parentOrgId)`.
